  ...
  return (
    <div className='flex flex-row items-center justify-center lg:justify-center w-full gap-3 flex-wrap'>
      {educations.map((education) => (
        <div className='flex flex-col items-center 2xl:gap-1 justify-center w-fit h-fit border border-white rounded-2xl text-white py-1 px-2 md:py-2 md:px-3 transition duration-300 ease-in-out hover:bg-black hover:scale-125 hover:shadow-lg hover:shadow-indigo-300/10'>
