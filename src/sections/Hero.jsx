  ...
  return (
    <div className='flex flex-col w-full h-full justify-center'>
        ...
        <div className='flex flex-col w-fit md:flex-row gap-3 mt-8'>
          ...
          <button className='flex flex-row gap-2 items-center bg-black text-white px-6 py-2 rounded-xl border border-white hover:shadow-xl hover:scale-105 hover:shadow-rose-600/20 hover:shadow-md'>
